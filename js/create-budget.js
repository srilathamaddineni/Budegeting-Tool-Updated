document.addEventListener('DOMContentLoaded', function () {
    ...
    let rowToDelete = null; // Track the row that is pending deletion
    let amountToDelete = 0; // Track the amount to delete   
    ...
    const confirmModal = document.getElementById('confirm-modal');  // Modal
    const confirmDeleteButton = document.getElementById('confirm-delete');  // Modal confirm
    const cancelDeleteButton = document.getElementById('cancel-delete');  // M
    ...
    confirmDeleteButton.addEventListener('click', function () {
        ...
        updateProgressBar();
        allocatedTotalDisplay.textContent = allocatedTotal.toFixed(2);
        rowToDelete.remove();  // Remove the saved row
        confirmModal.style.display = 'none';  // Hide the modal after deletion
    });
